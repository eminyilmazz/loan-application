...
public class LoanServiceImpl implements LoanService {
     ...
     * @return List<Loan> - List of the loans the customer applied before. Only approved loans if "approved" of objectNode is true.
     ...
     *
     * @param tckn
     * @return List<Loan> - List of the approved loans the customer applied before.
